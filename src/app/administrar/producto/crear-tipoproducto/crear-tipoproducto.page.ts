...
@Component({
  ...
  templateUrl: './crear-tipoproducto.page.html',
  styleUrls: ['./crear-tipoproducto.page.scss'],
})
export class CrearTipoproductoPage implements OnInit {
  ...
  ngOnInit() {
    this.tipoProductoService.listar().subscribe(p=>{
        this.tipoProductos = p;
    })
  }
  refrescar(event) {
    setTimeout(() => {
