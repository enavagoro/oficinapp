...
export class RegistrarPage implements OnInit {
  ...
  public guardarUsuario(id){
    this.usuario.menu = [
      ...
      {title:'Administrar : Cliente',permission:{c:true,r:true,u:true,d:true},url:'administrar/cliente',icon:'https://cdn-icons-png.flaticon.com/512/4814/4814842.png',principal:false},
